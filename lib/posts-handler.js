...
function addTrackingCookie(cookies, userName) {
  ...
  if (isValidTrackingId(requestedTrackingId, userName)) {
    ...
    // 8バイトの推測されにくい16進数を作成し、Int形式に変換
    // ※JavaScriptのNumberの最大値は2の53乗 - 1なので、53bit分(6.625byte)までしか扱えないため、8Byteの整数値をparseIntすると53bit分で丸められる
    // Number.MAX_SAFE_INTEGER = 2の53乗 - 1
